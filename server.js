  ...
  */
  ...
  socket.on('play_token', function(payload) {
    ...
    if(('undefined' === typeof game) || !game){
      var error_message = 'play_token couldn\'t find your game, command aborted';
      log(error_message);
      socket.emit('play_token_response', {
                                          result: 'fail',
                                          message: error_message
...
function send_game_update(socket, game_id, message){
  ...
  /* Make sure that only 2 peopleare in the game room */
  var roomObject;
  var numClients;
  do {
